...
const cls = {
  ...
  title:
    "font-['Sora',sans-serif] text-2xl sm:text-[28px] font-bold text-[#0f1f15] text-center tracking-tight",
  ...
  brand:
    "flex items-center justify-center gap-2 mb-4 text-[#1f5d3f] font-['Sora',sans-serif] font-bold text-base tracking-wide",
};
